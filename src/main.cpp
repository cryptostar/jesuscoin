...
#if defined(NDEBUG)
# error "JesusCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "JesusCoin Signed Message:\n";
...
{
    int64_t nSubsidy = 350000 * COIN;

        if(pindexBest->nHeight == 1)
        {
            nSubsidy = 350000 * COIN; // 1 billion coins for ico
        }
...
{
    RenameThread("jesuscoin-loadblk");
