...
git clone https://github.com/cryptostar/JesusCoin.git
cd JesusCoin
chmod +x linuxJesusCoin.sh
./linuxJesusCoin.sh --build

Linux x86_64:

git clone https://github.com/cryptostar/JesusCoin.git
cd JesusCoin
chmod +x linuxJesusCoin64.sh
./linux64JesusCoin.sh --build

Options:
--reset: update dependencies, clone JesusCoin repository
--force: if you are using other versions such as Debian version > 7

Example with options:
./linux64JesusCoin.sh --reset --force --build

After successful build, jesuscoind can be found in JesusCoin/src/
